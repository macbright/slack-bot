...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<cucumber>.freeze, ["~> 3.1.2"])
    s.add_development_dependency(%q<gherkin>.freeze, ["~> 5.1.0"])
    s.add_development_dependency(%q<aruba>.freeze, ["~> 0.7.4"])
    s.add_development_dependency(%q<sdoc>.freeze, ["~> 0.4"])
    s.add_development_dependency(%q<faker>.freeze, ["~> 1.9.1"])
  else
    ...
    s.add_dependency(%q<cucumber>.freeze, ["~> 3.1.2"])
    s.add_dependency(%q<gherkin>.freeze, ["~> 5.1.0"])
    s.add_dependency(%q<aruba>.freeze, ["~> 0.7.4"])
    s.add_dependency(%q<sdoc>.freeze, ["~> 0.4"])
    s.add_dependency(%q<faker>.freeze, ["~> 1.9.1"])
  end
end
